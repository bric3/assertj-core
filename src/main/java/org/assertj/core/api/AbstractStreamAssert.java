 ...
 */
public abstract class AbstractStreamAssert<S extends AbstractStreamAssert<S, A, T>, A extends Stream<? extends T>, T>
    extends AbstractAssert<S, A> implements ObjectEnumerableAssert<S, T> {

  @VisibleForTesting
  Iterables iterables = Iterables.instance();

  protected AbstractStreamAssert(A actual, Class<?> selfType) {
